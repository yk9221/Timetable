...
async function get_matches(course) {
    ...
    await fetch("https://api.easi.utoronto.ca/ttb/getOptimizedMatchingCourseTitles?term=" + course + "&divisions=APSC&sessions=20239&lowerThreshold=50&upperThreshold=200")
